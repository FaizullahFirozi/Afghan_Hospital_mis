<?php require_once("website/include/connection.inc.php"); ?>

<?php  // code for  about Hosptial
    $about_hospital = mysqli_query($con, "SELECT * FROM about_hospital ORDER BY about_id DESC LIMIT 5 ");
    $row_about_hospital = mysqli_fetch_assoc($about_hospital);
?>

<?php  // code for  Department
...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="website/assets/css/open-iconic-bootstrap.min.css"
    />
    ...
    <link
      rel="stylesheet"
      href="website/assets/css/owl.theme.default.min.css"
    />
    ...
    <link rel="stylesheet" href="website/assets/css/icomoon.css" />
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
          ...
          <div class="col-lg-12 d-block">
            <div class="row d-flex">
              <div class="col-md pr-4 d-flex topper align-items-center">
                ...
                <span class="text">+93 780002528</span>
              </div>
              <div class="col-md pr-4 d-flex topper align-items-center">
                <div
                  class="icon mr-2 d-flex justify-content-center align-items-center"
    ...
    >
      <div class="container">
        <a class="navbar-brand" href="index.php">Afghan Hospital</a>
        <button
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav nav ml-auto">
            ...
            <li class="nav-item">
              <a href="#news-section" class="nav-link"><span>News</span></a>
            </li>
            <li class="nav-item">
    ...
    <section
      ...
      style="background-image: url('website/assets/images/bg_3.jpg');"
      data-section="home"
      ...
      <div class="container">
        ...
        >
          <div class="col-md-6 pt-5 ftco-animate">
            <div class="mt-5">
              <span class="subheading">Welcome to Afghan Hospital</span>
        ...
        <div class="row d-flex">
          <div class="col-md-6 col-lg-5 d-flex">
            <div
              ...
              style="background-image: url(website/assets/images/about.jpg);"
            ></div>
          </div>
          <div class="col-md-6 col-lg-7 pl-lg-5 py-md-5">
            <div class="py-md-5">
              <div class="row justify-content-start pb-3">
                <div id="ftco-nav" class="col-md-12 heading-section ftco-animate p-4 p-lg-5">
                
                  <h2 class="mb-4">
                   <span> <?= $row_about_hospital["title"]; ?></span>
                  </h2>
                  <p>
                  ...
                  <p>
                    <a href="#" class=" btn btn-primary py-3 px-4"
                      >Make an appointment</a
                    >
                    <a href="#contact-us"  class="btn btn-secondary py-3 px-4"
                      >Contact us</a
                    >
                  </p>
                </div>
 ...
 <!-- News section firozi -->
    <section
      ...
      style="background-image: url(website/assets/images/footer-bg.jpg);"
    >
      <div class="overlay"></div>
      <div class="container">
        <div class="row justify-content-center pb-3">
          ...
          >
            <span class="subheading">Read news</span>
            <h2 class="mb-4 alert alert-success text-warning">Our Hospital News</h2>
          </div>
        </div>
            ...
            <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div
                    class="user-img"
                    style="
                      background-image: url(website/assets/images/news.png);
                    "
                  >
                    <span
                  ...
                  <div class="text px-4">
                    <h1 class="text-danger"><?= $row_news["title"]; ?></h1>
                    <p class="mb-4">
                    <?= $row_news["description"]; ?>
                    </p>
                    <p class="name"><?= $row_news["source"]; ?></p>
                    <span class="position text-warning"><?= $row_news["news_date"]; ?></span>
                  </div>
                </div>
              </div>
      ...
      <div class="container">
        <div class="row d-flex">
          ...
          <div class="col-md-5 d-flex">
            <div
              class="appointment-wrap bg-white p-4 p-md-5 d-flex align-items-center"
            >
    ...
    <section
      ...
      style="background-image: url(website/assets/images/bg_2.jpg);"
    >
      <div class="overlay"></div>
      <div class="container">
      ...
      <div class="container-fluid px-0">
        <div class="row no-gutters">
          <div class="col-md-4 d-flex">
            <div
              class="img img-dept align-self-stretch"
              style="background-image: url(website/assets/images/dept-1.jpg);"
            ></div>
          </div>
                ...
                <? do { ?>
                 <div class="department-wrap p-4 ftco-animate">
                  <div class="text p-2 text-center">
                    ...
                    <h3><a href="#"><?= $row_department["department_name"]; ?></a></h3>
                    <p>Far far away, behind the word mountains</p>
                  </div>
                </div>
              
                <? } while($row_department = mysqli_fetch_assoc($department)); ?>
            ...
            <div class="staff">
              <div class="img-wrap d-flex align-items-stretch">
                <div
                  ...
                  style="
                    background-image: url(dashboard/<?= $row_doctor["photo"]; ?>);
                  "
                ></div>
              </div>
              <div class="text pt-3 text-center">
                <h3 class="mb-2"><?= $row_doctor["firstname"]; ?></h3>
                <span class="position mb-2"><?= $row_doctor["lastname"]; ?></span>
                <div class="faded">
                  <p><?= $row_doctor["phone"]; ?>
                  ...
                  <p><a href="tel:<?= $row_doctor["phone"]; ?>" class="btn btn-primary">Contact</a></p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="staff">
              <div class="img-wrap d-flex align-items-stretch">
                <div
                  class="img align-self-stretch"
                  style="
                    background-image: url(website/assets/images/doc-1.jpg);
                  "
                ></div>
              </div>
              <div class="text pt-3 text-center">
            ...
            <div class="staff">
              <div class="img-wrap d-flex align-items-stretch">
                <div
                  class="img align-self-stretch"
                  style="
                    background-image: url(website/assets/images/doc-2.jpg);
                  "
                ></div>
              </div>
              <div class="text pt-3 text-center">
            ...
            <div class="staff">
              <div class="img-wrap d-flex align-items-stretch">
                <div
                  class="img align-self-stretch"
                  style="
                    background-image: url(website/assets/images/doc-3.jpg);
                  "
                ></div>
              </div>
              <div class="text pt-3 text-center">
            ...
            <div class="staff">
              <div class="img-wrap d-flex align-items-stretch">
                <div
                  class="img align-self-stretch"
                  style="
                    background-image: url(website/assets/images/doc-4.jpg);
                  "
                ></div>
              </div>
              <div class="text pt-3 text-center">
    ...
    <section
      class="ftco-facts img ftco-counter"
      style="background-image: url(website/assets/images/bg_3.jpg);"
    >
      <div class="overlay"></div>
      <div class="container">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a
                ...
                class="block-20"
                style="
                  background-image: url('website/assets/images/image_1.jpg');
                "
              >
              </a>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a
                ...
                class="block-20"
                style="
                  background-image: url('website/assets/images/image_2.jpg');
                "
              >
              </a>
              <div class="text d-block">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a
                ...
                class="block-20"
                style="
                  background-image: url('website/assets/images/image_3.jpg');
                "
              >
              </a>
              <div class="text d-block">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a
                ...
                class="block-20"
                style="
                  background-image: url('website/assets/images/image_4.jpg');
                "
              >
              </a>
              <div class="text d-block">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a
                ...
                class="block-20"
                style="
                  background-image: url('website/assets/images/image_5.jpg');
                "
              >
              </a>
              <div class="text d-block">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a
                ...
                class="block-20"
                style="
                  background-image: url('website/assets/images/image_6.jpg');
                "
              >
              </a>
              <div class="text d-block">
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h2 id="contact-us" class="mb-4">Contact Us</h2>
            <p>
              Far far away, behind the word mountains, far from the countries
              Vokalia and Consonantia
            </p>
        ...
        <div class="row d-flex contact-info mb-5">
          ...
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
            <div class="align-self-stretch box p-4 text-center bg-light">
              ...
              <p><a href="tel://0093780002528">+ 93 78000 25 28</a></p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
            <div class="align-self-stretch box p-4 text-center bg-light">
              ...
              <p><a href="mailto:faizullah.firozi@gamil.com">faizullah.firozi@gamil.com</a></p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
            <div class="align-self-stretch box p-4 text-center bg-light">
              ...
              <p><a href="https://www.wardak5.blogspot.com">wardak5.blogspot.com</a></p>
            </div>
          </div>
        </div>
        <div class="row no-gutters block-9">
          <div id="feedback" class="col-md-12 order-md-last d-flex">
            <form method="post" action="website/feedback.php" class="bg-light p-5 contact-form">
            <h1  class="alert-primary text-center">مونږ ته نظر را واستوئ</h1>  
            <div class="form-group">
                <input
                  type="text" required
                  class="form-control"
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                ...
                <li>
                  <a href="#"
                    ><span class="icon-long-arrow-right mr-2"></span>Nuclear
                    Magnetic</a
                  >
                </li>
                <li>
                  <a href="#"
                    ><span class="icon-long-arrow-right mr-2"></span>Surgical</a
                  >
                </li>
                <li>
                  <a href="#"
                ...
                <li>
                  <a href="#"
                    ><span class="icon-long-arrow-right mr-2"></span>Dental</a
                  >
                </li>
              </ul>
            </div>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                ...
                <li>
                  <a href="#"
                    ><span class="icon-long-arrow-right mr-2"></span>Doctors</a
                  >
                </li>
                <li>
                  <a href="#"
                ...
                <li>
                  <a href="#"
                    ><span class="icon-long-arrow-right mr-2"></span>Pricing</a
                  >
                </li>
                <li>
                  <a href="#"
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                <li>
                  <a href="#"
                    ><span class="icon-long-arrow-right mr-2"></span>Emergency
                    Services</a
                  >
                </li>
                <li>
                  <a href="#"
                    ><span class="icon-long-arrow-right mr-2"></span>Qualified
                    Doctors</a
                  >
                </li>
                <li>
                  <a href="#"
                    ><span class="icon-long-arrow-right mr-2"></span>Outdoors
                    Checkup</a
                  >
                </li>
                <li>
                  <a href="#"
                    ><span class="icon-long-arrow-right mr-2"></span>24 Hours
                    Services</a
                  >
                </li>
              </ul>
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li>
                    ...
                    ><span class="text"
                      >د کندز پوهنتون تر ځنګ د کندز شفاخانه</span
                    >
                  </li>
                  <li>
                    <a href="tel:0093780002528"
                      ><span class="icon icon-phone"></span
                      ><span class="text">+93 78000 2528</span></a
                    >
                  </li>
                  <li>
                    <a href="mailto:faizullah.firozi@.com"
                      ><span class="icon icon-envelope pr-4"></span
                      ><span class="text">faizullah.firozi@.com</span></a
                    >
                  </li>
                </ul>
              </div>
    ...
    <script src="website/assets/js/jquery-migrate-3.0.1.min.js"></script>
    <script src="website/assets/js/popper.min.js"></script>
    <script src="website/assets/js/bootstrap.min.js"></script>
    <script src="website/assets/js/jquery.easing.1.3.js"></script>
    <script src="website/assets/js/jquery.waypoints.min.js"></script>
    <script src="website/assets/js/jquery.stellar.min.js"></script>
    ...
    <script src="website/assets/js/jquery.animateNumber.min.js"></script>
    <script src="website/assets/js/scrollax.min.js"></script>
    <script src="website/assets/https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
    <script src="website/assets/js/google-map.js"></script>
